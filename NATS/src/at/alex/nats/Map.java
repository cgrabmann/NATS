...
public class Map extends Scene implements IAnalogOnScreenControlListener {
	...
	public void loadGameResources() {
		...
		leftAnalogAußenBitmapTextureAtlas = new BitmapTextureAtlas(
				nats.getTextureManager(), 200, 200, TextureOptions.DEFAULT);
		leftAnalogAußenITextureRegion = BitmapTextureAtlasTextureRegionFactory
				.createFromAsset(leftAnalogAußenBitmapTextureAtlas,
						nats.getApplicationContext(), "JoystickAusen.png", 0,
						0);
		leftAnalogAußenBitmapTextureAtlas.load();
		...
		leftAnalogOnScreenControl = new AnalogOnScreenControl(100, 100,
				mainCamera, leftAnalogAußenITextureRegion,
